...
public abstract class XmlUtils
{
    ...
    private static <T> T parseDocument(Class<T> clazz, Document doc) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException
    {
    ...
    private static void doFillObject(Class<?> clazz, Object obj, Element element, Field field) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException
    {
    ...
    private static <T> Map<String, Field> buildDataMapper(Field[] fields) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException
    {
    ...
    private static <T> void buildXmlUseFields(T t, StringBuffer sb, Class<?> clazz, Field[] fields) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException
    {
        Map<String, Field> mappers = buildDataMapper(fields);
